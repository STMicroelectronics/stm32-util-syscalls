...
# Release Notes for <mark>Syscalls</mark> SW Pack
...
More documentation is available at [Syscalls SW Pack online documentation](https://dev.st.com/stm32cube-docs/utilities-syscalls/latest/en/index.html).
...
- First Official release of **Syscalls**.
